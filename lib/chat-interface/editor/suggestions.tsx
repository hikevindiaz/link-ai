...
import { Suggestion as PreviewSuggestion } from '@/components/chat-interface/suggestion';
import type { Suggestion } from '@/lib/chat-interface/db/schema';
import { ArtifactKind } from '@/components/chat-interface/artifact';
