                ...
                <div className="flex flex-1 flex-col">
                    ...
                    <ScrollArea style={{ height: "70vh" }}>
                        <div className="flex-1 whitespace-pre-wrap space-y-4 p-4 text-sm">
                            <div className="flex items-center p-4 text-sm text-neutral-800 border border-neutral-300 rounded-lg bg-neutral-50" role="alert">
                                ...
                                return (
                                    <div key={message.id} className="space-y-4">
                                        <div className="flex max-w-5/6 items-end gap-2 justify-end" >
                                            <div className="rounded-lg flex max-w-5/6 bg-black dark:bg-white text-white dark:text-black p-2 self-end">
                                                <p className="text-md" >{message.message}</p>
                                            </div>
                                        </div>
                                        <div key="welcomemessage" className="flex items-end gap-2">
                                            <div className="rounded-lg bg-card-light dark:bg-card-dark text-neutral-700 dark:text-neutral-200 p-2">
