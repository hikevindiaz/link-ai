      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-hidden flex flex-col" ref={dialogContentRef}>
        ...
        <div className="mt-4 space-y-4 overflow-y-auto flex-1">
          <div className="px-1">
            ...
            <div>
              <label htmlFor="form-name" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300">
                Form Name
              </label>
              <input
                type="text"
                id="form-name"
                className="mt-1 block w-full rounded-xl border border-neutral-300 px-3 py-2 shadow-sm focus:border-neutral-500 focus:outline-none focus:ring-neutral-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 sm:text-sm"
            ...
            <div className="mt-4">
              <label htmlFor="form-description" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                {predefinedFields.map((field, index) => (
                  <button
                    ...
                    className="flex items-center justify-between rounded-xl border border-neutral-300 px-3 py-2 text-left text-sm hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-800 dark:text-neutral-200"
                  >
                    <span className="font-medium">{field.name}</span>
                    <RiAddLine className="h-4 w-4 text-neutral-500 dark:text-neutral-400" />
                  </button>
                ))}
                ...
                <button
                  ...
                  className="flex items-center justify-between rounded-xl border border-dashed border-neutral-300 px-3 py-2 text-left text-sm hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-800 dark:text-neutral-200"
                >
              ...
              {/* Custom Field Form */}
              {showCustomField && (
                <div className="rounded-xl border border-neutral-300 p-3 mb-4 dark:border-neutral-700">
                  ...
                  <div className="space-y-3">
                    <div>
                      <label htmlFor="custom-field-name" className="block text-xs font-medium text-neutral-700 dark:text-neutral-300">
                        Field Name
                      </label>
                      <input
                        type="text"
                        id="custom-field-name"
                        className="mt-1 block w-full rounded-xl border border-neutral-300 px-3 py-1.5 shadow-sm focus:border-neutral-500 focus:outline-none focus:ring-neutral-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 sm:text-xs"
                    ...
                    <div>
                      <label htmlFor="custom-field-description" className="block text-xs font-medium text-neutral-700 dark:text-neutral-300">
                        Description (optional)
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        className="h-4 w-4 rounded border-neutral-300 text-neutral-600 focus:ring-neutral-500 dark:border-neutral-700"
                        checked={customFieldRequired}
                        onChange={(e) => setCustomFieldRequired(e.target.checked)}
                      />
                      <label htmlFor="custom-field-required" className="ml-2 block text-xs font-medium text-neutral-700 dark:text-neutral-300">
                        Required field
                      </label>
                    </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 max-h-60 overflow-y-auto">
                    {fields.map((field) => (
                      <li 
                        key={field.id}
                        className="flex items-center justify-between rounded-xl border border-neutral-200 px-3 py-2 text-sm dark:border-neutral-700"
                      >
                        <div className="flex items-center">
                          <RiDraggable className="mr-2 h-4 w-4 text-neutral-400" />
                          <div>
                            <p className="font-medium text-neutral-700 dark:text-neutral-300">{field.name}</p>
