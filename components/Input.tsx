...
const inputStyles = tv({
  base: [
    ...
    // file
        ...
        "file:border-solid file:border-neutral-300 file:bg-neutral-50 file:text-neutral-500 file:hover:bg-neutral-100 file:dark:border-neutral-800 file:dark:bg-black file:hover:dark:bg-neutral-900/20 file:disabled:dark:border-neutral-700",
