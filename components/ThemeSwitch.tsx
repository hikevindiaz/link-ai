    ...
    >
      <div
        className={cn(
          ...
          "bg-transparent",
          // checked
          "group-data-[state=checked]:bg-neutral-50 group-data-[state=checked]:text-neutral-600 dark:group-data-[state=checked]:bg-neutral-500/20 dark:group-data-[state=checked]:text-neutral-300",
          // focus
          focusRing,
        )}
      >
