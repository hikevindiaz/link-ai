...
export const CustomTooltip = ({ payload, active }: TooltipProps) => {
  ...
  return (
    <div className="flex w-56 items-start justify-between rounded-xl border border-neutral-200 bg-white p-2 text-sm shadow-md dark:border-neutral-800 dark:bg-neutral-950">
...
export const CustomTooltip2 = ({
  ...
  return (
    <div className="w-56 rounded-xl border border-neutral-200 bg-white text-sm shadow-md dark:border-neutral-800 dark:bg-neutral-950">
      <ul role="list" className="grid grid-cols-2 gap-x-4 p-2">
        {categoriesToShow.map((category, index) => (
          <li key={index} className="flex space-x-2.5">
            ...
            />
            <div className="space-y-0.5">
              <p className="whitespace-nowrap text-xs text-neutral-500 dark:text-neutral-500">
                {category}
              </p>
              <p className="font-medium text-neutral-900 dark:text-neutral-50">
                {category === "Quotes"
      ...
      <div className="border-t border-neutral-200 p-2 dark:border-neutral-800">
        <p className="inline-flex w-full justify-center rounded bg-neutral-100 px-1.5 py-1 text-xs text-neutral-600 dark:bg-neutral-400/20 dark:text-neutral-400">
          {ratio > 0.3
            ? "Critical ratio"
            : ratio > 0.25
              ? "Moderate ratio"
...
export const CustomTooltip3 = ({ payload, active }: TooltipProps) => {
  ...
  return (
    <div className="w-56 rounded-xl border border-neutral-200 bg-white text-sm shadow-md dark:border-neutral-800 dark:bg-neutral-950">
      ...
      <div className="border-t border-neutral-200 p-2 dark:border-neutral-800">
        <div className="relative mt-0.5 h-1.5 w-full rounded-full bg-neutral-200 dark:bg-neutral-800">
          <span className="absolute left-1/2 top-1/2 z-30 h-2.5 w-0.5 -translate-y-1/2 rounded-full bg-neutral-500 dark:bg-neutral-500" />
          {percentageDiff >= 0 ? (
            <span className="absolute left-1/2 top-1/2 z-10 h-1.5 w-1/2 -translate-y-1/2">
              <span
                ...
                className="absolute h-1.5 rounded-r-full bg-gradient-to-r from-neutral-400 to-neutral-300 dark:from-neutral-400 dark:to-neutral-500"
              />
            </span>
          ) : (
            <span className="absolute right-1/2 top-1/2 z-10 h-1.5 w-1/2 -translate-y-1/2">
              <span
                ...
                className="absolute right-0 h-1.5 rounded-l-full bg-gradient-to-l from-neutral-400 to-neutral-300 dark:from-neutral-400 dark:to-neutral-500"
              />
            </span>
          )}
        </div>
        <div className="mt-1 flex items-center justify-between">
          <div className="flex items-center">
            <span
              className="mr-1 h-0.5 w-2.5 rounded-full bg-neutral-500 dark:bg-neutral-500"
              aria-hidden="true"
            />
  ...
  return (
    <div className="w-56 rounded-xl border border-neutral-200 bg-white text-sm shadow-md dark:border-neutral-800 dark:bg-neutral-950">
      <ul role="list" className="grid grid-cols-2 gap-x-4 p-2">
        ...
        <li className="flex space-x-2.5">
          <span
            className="w-1 rounded bg-neutral-400 dark:bg-neutral-600"
            aria-hidden="true"
          />
          <div className="space-y-0.5">
            <p className="whitespace-nowrap text-xs text-neutral-500 dark:text-neutral-500">
