...
export default function InboxLoading() {
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Left Sidebar: Conversations List Loading */}
      <div className="w-96 border-r border-neutral-200 dark:border-neutral-800 flex flex-col">
        <div className="p-4 pb-0">
          <div className="flex items-center justify-between">
            <Skeleton className="h-8 w-20 bg-neutral-200 dark:bg-neutral-700" />
        ...
        <div className="px-4 pb-4 flex-1 overflow-auto">
          <div className="grid grid-cols-1 gap-2 mt-4">
            ...
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div 
                key={i}
                className="p-3 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black"
              >
                <div className="flex items-start space-x-3">
                  <Skeleton className="h-10 w-10 rounded-full bg-neutral-200 dark:bg-neutral-700 flex-shrink-0" />
      ...
      {/* Main Content: Chat Thread Loading */}
