...
export default function CodeExampleTabs({
  ...
  return (
    ...
    >
      ...
      >
        <Tabs.Trigger
          className="group relative flex flex-1 flex-col items-start justify-start rounded-xl p-6 text-left shadow-lg ring-1 ring-neutral-200 dark:ring-white/5 dark:data-[state=active]:shadow-neutral-900/30"
          value="tab1"
        >
