...
} from '@/components/chat-interface/console';
...
export const codeArtifact = new ArtifactBase<'code', Metadata>({
  kind: 'code',
  description:
    'Useful for code generation; Code execution is only available for python code.',
  initialize: async ({ setMetadata }: { setMetadata: (data: Metadata) => void }) => {
    setMetadata({
      outputs: [],
    });
  },
