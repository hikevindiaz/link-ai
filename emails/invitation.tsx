          ...
          <Container className="bg-white rounded-[8px] shadow-lg max-w-[600px] mx-auto overflow-hidden">
            ...
            <Section className="p-[40px]">
              ...
              <Section className="mb-[32px] bg-indigo-50 p-[24px] rounded-[8px]">
                ...
                <Text className="text-[14px] text-neutral-700 leading-[1.6]">
                  {role === 'ADMIN' 
              ...
              <Section className="text-center mb-[32px]">
                ...
                <Text className="text-[14px] text-neutral-500 mb-[16px]">
                  This invitation expires on {expiryDate}
                </Text>
                <Text className="text-[12px] text-neutral-400 leading-[1.4]">
              ...
              <Section className="mb-[32px] bg-neutral-50 p-[24px] rounded-[8px]">
                ...
                <Text className="text-[14px] text-neutral-700 mb-[12px] leading-[1.6]">
              ...
              <Section className="mb-[32px]">
                ...
                <Text className="text-[16px] text-neutral-700 leading-[1.6] font-semibold">
                  Best regards,<br />
                  The Link AI Team<br />
                  <span className="text-[14px] text-neutral-500 font-normal">Link AI</span>
                </Text>
              </Section>
